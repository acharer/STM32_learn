...
typedef enum
{
	...
	GPIO_Mode_IN__FLOATING = 0x04,	//浮空输入		(0000 0000)b
	GPIO_Mode_IPD = 0x28,			//下拉输入		(0000 0000)b
	GPIO_Mode_IPU = 0x48,			//上拉输入		(0000 0000)b
	
	GPIO_Mode_Out_OD = 0x14,		//开漏输出		(0000 0000)b
	GPIO_Mode_Out_PP = 0x10,		//推挽输出		(0000 0000)b
	GPIO_Mode_AF_OD = 0x1C,			//复用开漏输出		(0000 0000)b
	GPIO_Mode_AF_PP = 0x18			//复用推挽输出		(0000 0000)b
}GPIOMode_TypeDef;
